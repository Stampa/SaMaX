namespace SamaxLibraryTests
{
    ...
    [TestFixture]
    public class PingClientToServerSidMessageTestFixture
    {
        ...
        {
            Assert.That(PingClientToServerSidMessage.MessageType, Is.EqualTo(SidMessageType.Ping));
        }
        ...
        private PingClientToServerSidMessage CreateMessage(byte[] messageBytes)
        {
